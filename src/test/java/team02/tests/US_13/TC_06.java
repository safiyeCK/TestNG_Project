...
public class TC_06 { //PASSED
    /*
    Vendor kullanici, My Accounts-Adresses sayfasindaki Town / City kutusunu bos biraktiginda
Shipping Address (Fatura Adresi) ekleyememeli.
    ...
    public void tc06() {
        ...
        //Town / City kutusunu bos birak
        //Town / City kutusu haric tum zorunlu alanlari doldur
        ...
        myAccountPage.shippingAddressStreetAddressKutusu1Ep.sendKeys(faker.address().streetAddress(),
                Keys.TAB, faker.address().streetAddress(),Keys.TAB,Keys.TAB,"Alabama", Keys.TAB);
        ReusableMethods.bekle(1);
        ...
        //"Town / City is a required field." yazisinin ciktigini ve hesap degisikligi yapilamadigini dogrula
        ReusableMethods.scroll(myAccountPage.shippingAddressTownCityWarningMessageEp);
        Assert.assertEquals(myAccountPage.shippingAddressTownCityWarningMessageEp.getText(), "Town / City is a required field.");
