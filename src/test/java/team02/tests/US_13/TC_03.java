...
Shipping Address (Fatura Adresi) ekleyememeli.
    ...
    public void deneme() {
        ...
        //Last name harici tum zorunlu alanlari doldur
        ...
        ReusableMethods.scroll(myAccountPage.shippingAddressLastNameWarningEp);
        Assert.assertEquals(myAccountPage.shippingAddressLastNameWarningEp.getText(), "Last name is a required field.");
