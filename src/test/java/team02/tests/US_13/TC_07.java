...
Shipping Address (Fatura Adresi) ekleyememeli.
    ...
    public void tc07() {
        ...
        myAccountPage.shippingAddressTownCityKutusuEp.sendKeys(faker.address().city(),
                Keys.TAB,"Alabama",Keys.TAB,Keys.TAB);
        ...
        ReusableMethods.scroll(myAccountPage.shippingAddressZipCodeWarningMessageEp);
        Assert.assertEquals(myAccountPage.shippingAddressZipCodeWarningMessageEp.getText(),"ZIP Code is a required field.");
