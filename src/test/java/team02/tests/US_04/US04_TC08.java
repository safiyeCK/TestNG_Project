...
public class US04_TC08 {
    ...
    public void test08() {
        ...
        // Country/Region secimi yapmadan save kutusuna bas
        ReusableMethods.scroll(myAccountPage.shippingSaveAddressKutusu);
        ReusableMethods.bekle(3);
        myAccountPage.shippingSaveAddressKutusu.click();
        ReusableMethods.bekle(3);

        // "Country/Region is a required field." Uyarisini gör
        ReusableMethods.scroll(myAccountPage.shippingCountryDdmNegatifMesajKutusu);
        Assert.assertEquals(myAccountPage.shippingCountryDdmNegatifMesajKutusu.getText(),"Country / Region is a required field.");
