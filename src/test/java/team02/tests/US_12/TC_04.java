...
public class TC_04 {
/*
        Vendor kullanici, My Accounts-Adresses sayfasindaki Last Name kutusunu bos biraktiginda
Billing Address (Fatura Adresi) ekleyememeli.
         */

    @Test
    public void testTc04() { //PASSED
        ...
        myAccountPage.billingAddressLastNameEp.clear();
        ...
        //"Last name is a required field." yazisinin ciktigini ve hesap degisikligi yapilamadigini dogrula
        ReusableMethods.scroll(myAccountPage.billingLastnameNegatifMesajiEp);
        Assert.assertEquals(myAccountPage.billingLastnameNegatifMesajiEp.getText(),"Last name is a required field.");
