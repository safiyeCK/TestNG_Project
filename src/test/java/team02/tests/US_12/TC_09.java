...
public class TC_09 { //PASSED
    /*
        Vendor kullanici, My Accounts-Adresses sayfasindaki Phone kutusunu bos biraktiginda
Billing Address (Fatura Adresi) ekleyememeli.
    ...
    public void testTc09() {
        ...
        //Phone kutusuna bos birak
        myAccountPage.billingAddressPhoneEp.clear();
        ...
        //"Phone is a required field." yazisinin ciktigini ve hesap degisikligi yapilamadigini dogrula
        ReusableMethods.scroll(myAccountPage.billingAddressPhoneRequiredFieldEp);
        Assert.assertEquals(myAccountPage.billingAddressPhoneRequiredFieldEp.getText(),"Phone is a required field.");
