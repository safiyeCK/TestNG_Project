...
public class TestCase_08 {
    ...
    public void test01() {
        ...
        //12 My orders' a click yap
        ReusableMethods.scrollEnd();
        ReusableMethods.bekle(3);
        cartPage.myOrdersRA.click();
        ReusableMethods.bekle(3);

        //13 Ilk Order number' a click yap}
        cartPage.ilkOrderViewRA.click();

        //14 Ilk Order number' a click yapildigini dogrula ("ORDER DETAILS" yazisi gorulmeli)
        Assert.assertTrue(cartPage.orderDetailsRA.getText().contains("ORDER DETAILS"));
    }
 }
