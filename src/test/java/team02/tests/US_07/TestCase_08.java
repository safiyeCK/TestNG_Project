...
public class TestCase_08 {
    ...
    //Kullanıcı karşılatırma ekranından ürünleri silebilmeli
    @Test
    public void test01() {
        //Siteye git
        ...
        //Sona kalan urunun uzerindeki carpi isaretine tikla
        comparePage.removeFromComparePage.click();

        //"Compare" ekranindan urunun silindigini dogrula
        ReusableMethods.bekle(2);
        List<WebElement> compareProducts2= Driver.getDriver().findElements(By.xpath("//*[@class='attachment-woocommerce_thumbnail size-woocommerce_thumbnail']"));
